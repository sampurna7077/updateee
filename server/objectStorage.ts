...
export class ObjectStorageService {
  ...
  async uploadAdvertisementFile(
    ...
    try {
      // Upload file buffer directly to Google Cloud Storage
  ...
  async getAdvertisementFile(objectPath: string): Promise<File> {
  ...
  normalizeAdvertisementPath(rawPath: string): string {
